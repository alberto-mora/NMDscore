...
##Abre el archivo csv
filename = '/home/vant/Miao2/Miao2_2.csv' #Dataframe con las variantes somáticas, se puede descargar de Miao et al., 2018
...
df['ID_specific'] = df[chr].astype(str) + '_' + df[position].astype(str) + '_' + df['VEP_allele'] + '_' + df['pair_id']
...
df.to_csv('new_NMD_Miao2.csv',sep='\t',index = None)
